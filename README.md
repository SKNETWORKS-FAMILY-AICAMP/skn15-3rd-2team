...
취업 준비를 하면 수많은 공고가 있고 이런 공고들 중 **내게 필요한 것들을 찾는 데에는 많은 시간**을 필요로 합니다. 이 챗봇은 **사용자의 희망 조건(직무·지역·급여·근무형태 등)** 과 **내 능력(자격증, 사용 기술, 프로젝트 경험 등)** 을 입력받고, **입력받은 데이터를 토대로 거기에 부합하는 공고만** 추려줍니다.  
...
**취업하Job**은 위에서 정리한 문제를 해결하기 위해, 사용자의 조건과 역량을 한 번에 받아  
...
사용자 입력을 기반으로 LLM이 스펙을 구조화하고, 역할/키워드를 확장합니다.

확장된 역할을 기준으로 Playwright 크롤러가 잡코리아에서 공고를 수집합니다.

결과는 역할별 공고 리스트 형태로 Streamlit UI에 출력됩니다.

<p align="center"> <img src="https://github.com/user-attachments/assets/e7684509-47f6-40c0-80b5-6784a5559bd3" alt="공고 시스템 아키텍처" width="1000"> </p>


### ✍️ 자기소개서 생성 시스템

입력된 회사명, 직무, 개인 스펙을 바탕으로 기업 DB(인재상, 예시 자소서)를 조회합니다.

조회된 정보와 함께 LLM용 프롬프트를 구성해 자소서를 생성합니다.

생성된 자소서는 LLM 기반 평가 피드백까지 포함하여 Streamlit UI에 출력됩니다.

<p align="center"> <img src="https://github.com/user-attachments/assets/251a6e96-69c1-49d2-9477-4962488901a8" alt="자기소개서 시스템 아키텍처" width="1000"> </p>
